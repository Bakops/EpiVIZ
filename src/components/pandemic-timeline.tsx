...
export function PandemicTimeline({ pandemic }: PandemicTimelineProps) {
  ...
  const timelineEvents: { [key: string]: { date: string; event: string }[] } = {
    covid19: [
      {
        date: "31 déc. 2019",
        event:
          "Premiers cas de pneumonie d'origine inconnue signalés à Wuhan, Chine",
      },
      {
        date: "7 jan. 2020",
        event: "Identification du nouveau coronavirus (SARS-CoV-2)",
      },
      {
        date: "13 jan. 2020",
        event: "Premier cas confirmé hors de Chine (Thaïlande)",
      },
      {
        date: "23 jan. 2020",
        event: "Confinement de Wuhan et d'autres villes chinoises",
      },
      {
        date: "30 jan. 2020",
        event:
      ...
      { date: "11 mars 2020", event: "L'OMS déclare une pandémie mondiale" },
      {
        ...
        event: "Confinements dans de nombreux pays du monde",
      },
      { date: "Déc. 2020", event: "Début des campagnes de vaccination" },
      {
        date: "2021-2022",
        event:
          "Émergence de variants préoccupants (Alpha, Beta, Delta, Omicron)",
      },
      {
        date: "Mai 2023",
        event: "L'OMS déclare la fin de l'urgence de santé publique mondiale",
      },
    ],
    spanish_flu: [
      {
        date: "Mars 1918",
        event: "Premiers cas signalés au Kansas, États-Unis",
      },
      {
        date: "Avril 1918",
        event: "Propagation en Europe via les troupes américaines",
      },
      {
        date: "Août 1918",
        event: "Début de la deuxième vague, beaucoup plus mortelle",
      },
      {
        date: "Sept-Nov 1918",
        event: "Pic de la pandémie, systèmes de santé débordés",
      },
      {
        date: "Déc. 1918",
        event: "Diminution des cas dans de nombreuses régions",
      },
    ...
    black_death: [
      ...
      {
        date: "Oct. 1347",
        event: "Arrivée à Messine, Sicile, via des navires marchands",
      },
    ...
    sars: [
      ...
      {
        date: "Juillet 2003",
        event: "L'OMS déclare la fin de la transmission",
      },
    ],
    h1n1_2009: [
      ...
      {
        date: "Avril 2009",
        event: "L'OMS déclare une urgence de santé publique",
      },
      { date: "Juin 2009", event: "L'OMS déclare une pandémie" },
      {
        date: "Oct-Nov 2009",
        event: "Pic de la pandémie dans l'hémisphère nord",
      },
      {
        date: "Déc. 2009",
        event: "Début des campagnes de vaccination de masse",
      },
